          ...
          <ModalUpper>
            ...
            <CardSection gap="md">
              ...
              <ThemedText.White fontWeight={700} fontSize={36}>
                <Trans>{unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} ENP</Trans>
              </ThemedText.White>
            </CardSection>
            <Break />
            <CardSection gap="sm">
        ...
        <ConfirmOrLoadingWrapper activeBG={true}>
          ...
          <ConfirmedIcon>
            {!claimConfirmed ? (
              ...
              <UniTokenAnimated width="72px" src={tokenLogo} alt="ENP" />
            )}
          </ConfirmedIcon>
